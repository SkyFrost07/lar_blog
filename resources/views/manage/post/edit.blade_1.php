...
<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <div class="form-group thumb_box">
            ...
            @if($item->thumb_id)
            <input type="hidden" ng-init='submit_files=[{"id":"{{$item->thumb_id}}"}]'>
            @endif
...
<script>
    ...
    (function($){
        tinymce.init({
            ...
            toolbar: "heading bold underline italic alignleft aligncenter alignright alignjustify bullist numlist outdent indent table link image forecolor backcolor | ex_loadfile undo redo  code"
        });
    })(jQuery);
</script>
