...
$config = array(
	...
	*/
	...
	'fixed_path_from_filemanager'             => ['../../uploads/medium/', '../../uploads/large'], //fixed path of the image folder from the current position on upload folder
	'fixed_image_creation_name_to_prepend'    => ['', ''], //name to prepend on filename
	'fixed_image_creation_to_append'          => ['', ''], //name to appendon filename
	'fixed_image_creation_width'              => [300, 800], //width of image (you can leave empty if you set height)
